...
#include "../SDK/Game/MinecraftUIRenderContext/MinecraftUIRenderContext.h"
#include "../SDK/MoveInputHandler.h"
#include "../SDK/RakNetConnector.h"
#include "../SDK/Struct/TextHolder.h"
#include "../SDK/UIScene.h"
#include "../SDK/Utils/Logger.h"
#include "../SDK/Utils/SkinUtil.h"
...
private:
	...
	static int Mob_getCurrentSwingDuration(void* a1);
	...
	static float getInterpolatedHeadYaw(Player* _this, float a1);//SMOOTH
	static float getInterpolatedBodyYaw(Player* _this, float a1);//SMOOTH
	static float* yRot(Player* _this, float* a2, float a3);//SMOOTH
	...
	std::unique_ptr<FuncHook> Mob_getCurrentSwingDurationHook;
	std::unique_ptr<FuncHook> Actor__setRotHook;
	std::unique_ptr<FuncHook> getDestroySpeedHook;

	std::unique_ptr<FuncHook> getInterpolatedHeadYawO;//SMOOTH
	std::unique_ptr<FuncHook> getInterpolatedBodyYawO;//SMOOTH
	std::unique_ptr<FuncHook> yRotO;//SMOOTH
