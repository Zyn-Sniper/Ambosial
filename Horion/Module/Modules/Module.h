...
protected:
	...
	void addFloat(std::string name, float* floatPtr, float defaultValue, float minValue, float maxValue);
	void addInt(std::string name, int* intpTr, int defaultValue, int minValue, int maxValue);
	void addEnum(std::string name, SettingEnum* intPtr);
	void addBool(std::string name, bool* boolPtr, bool defaultValue);
