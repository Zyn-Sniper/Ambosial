...
Radar::Radar() : IModule(0, Category::CLIENT, "Radar.") {
	addBool("Show Grid", &grid, true);
	addInt("Size", &size, size, 50, 200);
	addFloat("Pixel Size", &pixelSize, pixelSize, 2, 4);
	addFloat("Zoom", &zoom, zoom, 1.0f / 4.0f, 4.0f);
	addFloat("Background Opacity", &bgOpacity, bgOpacity, 0.1f, 1.0f);
	addFloat("Pixel Opacity", &pxOpacity, pxOpacity, 0.1f, 1.0f);
}
