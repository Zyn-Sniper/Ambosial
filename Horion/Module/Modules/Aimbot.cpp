...
Aimbot::Aimbot() : IModule(0, Category::COMBAT, "Automatically aims at the nearest entity.") {
	addFloat("Range", &range, range, 3.f, 8.f);
	addBool("Require Click", &click, click);
	addBool("Only Swords/Axes", &sword, sword);
	addBool("Vertical", &vertical, vertical);
	addFloat("Horizontal Speed", &horizontalspeed, horizontalspeed, 10.f, 90.f);
	addFloat("Vertical Speed", &verticalspeed, verticalspeed, 10.f, 90.f);
	addFloat("Horizontal Range", &horizontalrange, horizontalrange, 20.f, 180.f);
	addFloat("Vertical Range", &verticalrange, verticalrange, 20.f, 180.f);
