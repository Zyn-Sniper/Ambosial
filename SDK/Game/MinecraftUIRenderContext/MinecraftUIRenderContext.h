...
public:
	...
	TexturePtr* getTexture(TexturePtr* texture, FilePath& resourceLocation, bool idk) {
		return Utils::CallVFunc<29, TexturePtr*, TexturePtr*, FilePath&>(this, texture, resourceLocation, idk);
	};
};
