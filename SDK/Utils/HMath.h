...
*/
inline float easingLinear(float currentTime, float startValue, float changeValue, float duration) {
	return changeValue * currentTime / duration + startValue;
}

inline float easingEaseInCubic(float currentTime, float startValue, float changeValue, float duration) {
	currentTime /= duration;
	return changeValue * currentTime * currentTime * currentTime + startValue;
}

inline float easingEaseOutCubic(float currentTime, float startValue, float changeValue, float duration) {
	currentTime /= duration;
	currentTime--;
